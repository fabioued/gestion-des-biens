...
import MissionsNumeroter from '../../components/Missions/numeroter';
...
class Index extends React.Component {
  ...
  componentWillMount() {
    if (this.props.authUser) {
      ...
      this.props.getMissionsNumeroter(user.IdUtilisateur).then((missions) => {
...

                    {
                      this.state.missions.length ?
                        <MissionsNumeroter
                          ...
                          numeroter={this.props.numeroter}
